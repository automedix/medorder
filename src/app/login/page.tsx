...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-black"
      ...
      {/* Footer - sichtbar auf der Login-Seite */}
      <footer className="py-4 text-center text-white/80 text-sm" style={{backgroundColor: '#4477BB'}}>
        <p>Vibecoded mit OpenClaw and Clawi.ai</p>
      </footer>
    </div>
  )
}
